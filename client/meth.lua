...
exports['qb-target']:AddBoxZone("ingridientsmeth",vector3(1005.7, -3201.28, -39.55),1.5, 1.75, { -- 963.37, .z-2122.95, 31.47
		...
		options = {
			...
			action = function()
				if amonia == nil then
					...
					MethCooking()
					exports['qb-target']:AddBoxZone("adjustdials",vector3(1007.89, -3201.17, -38.99),1.5, 1.75, { -- 963.37, .z-2122.95, 31.47
					name = "adjustdials",
					heading = 11.0,
					debugPoly = false,
					minZ = -39-2,
