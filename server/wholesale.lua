...
RegisterServerEvent('md-drugs:server:wholesalecoke', function()	
	...
	local price = math.random(Price['coke'].min, Price['coke'].max)
...
RegisterServerEvent('md-drugs:server:wholesalecrack', function()
	local src = source
    local Player = getPlayer(src)
	local price = math.random(Price['crack'].min, Price['crack'].max)
...
RegisterServerEvent('md-drugs:server:wholesalelsd', function()
	local src = source
    local Player = getPlayer(src)
	local price = math.random(Price['lsd'].min, Price['lsd'].max)
...
RegisterServerEvent('md-drugs:server:wholesaleheroin', function()
	local src = source
    local Player = getPlayer(src)
	local price = math.random(Price['heroin'].min, Price['heroin'].max)
...
RegisterServerEvent('md-drugs:server:wholesalextc', function()
	local src = source
    local Player = getPlayer(src)
	local price = math.random(Price['xtc'].min, Price['xtc'].max)
