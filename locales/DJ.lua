...
Lang.Catches = {
    ...
    itemMissings = 'CHECK IT! You need: %s',
...
Lang.Whippit = {
    targetShop = 'Open Whippit Shop, PARTY TIME!',
    needBalloon = 'Need a balloon for this, HYPE!',
    needCanister = 'Need a canister for this, WOO!',
    shopHeader = 'Whippit Shop, LET’S GO!',
}
return Lang
