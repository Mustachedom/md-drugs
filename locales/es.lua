...
Lang.Whippit = {
    targetShop = 'Abrir tienda Whippit',
    needBalloon = 'Necesitas un globo para esto',
    needCanister = 'Necesitas un bote para esto',
    shopHeader = 'Tienda Whippit',
}
